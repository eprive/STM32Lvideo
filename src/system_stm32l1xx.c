...
static void SetSysClock(void)
{
  ...
  /* Enable HSE
  //  RCC->CR |= ((uint32_t)RCC_CR_HSEON); // This is the setting when an external crystal is used
	But we don't have a crystal installed and use the MCO Clock of the ST-Link
	on the Discovery board instead. This requires setting the HSE Bypass bit.
	*/
